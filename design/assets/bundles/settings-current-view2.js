...
`;
  ...
  const classes = {
    ...
    scopePresetButtonCost,
    scopePresetNotes,
    scopePresetNoteRow,
    scopePresetNoteLabel,
    scopePresetNoteText,
    scopeComposer,
    scopeComposerHeader,
    scopeComposerTitle,
  ...
  function SettingsViewV2() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: classes.page, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.shell, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: classes.header, "data-settings-role": "header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.headerCopy, "data-settings-role": "header-copy", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.title, children: "Northlight Settings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.subtitle, children: "Control ranking, preview, clipboard history, snippets, aliases, scopes, and launcher utility-window behavior in one place." })
        ] }),
