...
`;
  ...
  function stripFileDecorations(value) {
    ...
    const basename2 = withoutApp.split("/").at(-1) ?? withoutApp;
    const extensionStart = basename2.lastIndexOf(".");
    if (extensionStart <= 0) {
      return withoutApp;
    }
    return withoutApp.slice(0, withoutApp.length - (basename2.length - extensionStart));
  }
  ...
  function LauncherBar({ mockState: mockState2 }) {
    ...
    const [isDevToolsPinned, setIsDevToolsPinned] = reactExports.useState(Boolean(mockState2 == null ? void 0 : mockState2.isDevToolsPinned));
    ...
    const pathCompletionPanelRef = reactExports.useRef(null);
    ...
    reactExports.useEffect(() => {
      ...
      const selectedRow = (_a = pathCompletionPanelRef.current) == null ? void 0 : _a.querySelector('[data-path-completion-selected="true"]');
      selectedRow == null ? void 0 : selectedRow.scrollIntoView({ block: "nearest" });
    ...
    const toggleDevToolsPinned = reactExports.useCallback(() => {
      if (isMock) {
        setIsDevToolsPinned((current) => !current);
        focusActiveInput();
        return;
      }
      void launcherRuntime.toggleDevToolsPinned().then((nextPinned) => {
        setIsDevToolsPinned(nextPinned);
        focusActiveInput();
      }).catch(() => void 0);
    }, [focusActiveInput, isMock]);
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.headerLeft, "data-launcher-role": "header-left", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.themeSwitchLabel, "data-launcher-role": "devtools-toggle-label", children: "Inspect" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.themeSwitchValue, "data-launcher-role": "devtools-toggle-value", children: isDevToolsPinned ? "On" : "Off" })
                  ]
                }
              )
            ] }),
