(function() {
  ...
  function darken(color, alpha2) {
    ...
    const f = 1 - alpha2;
    const dark = (input2) => Math.round(input2 * f);
  ...
  function convertCssVariables(input2, selector) {
    const sharedVariables = cssVariablesObjectToString(input2.variables);
    const shared = sharedVariables ? wrapWithSelector(selector, sharedVariables) : "";
    const dark = cssVariablesObjectToString(input2.dark);
    const light = cssVariablesObjectToString(input2.light);
  ...
  const defaultCssVariablesResolver = (theme2) => {
    ...
    keys(headings).forEach((heading) => {
      ...
      result.variables[`--mantine-${heading}-font-weight`] = headings[heading].fontWeight || theme2.headings.fontWeight;
    });
    return result;
  };
  ...
  function removeDefaultVariables(input2) {
    ...
    keys(input2.variables).forEach((key) => {
      if (defaultCssVariables.variables[key] !== input2.variables[key]) {
        cleaned.variables[key] = input2.variables[key];
      }
    });
    keys(input2.light).forEach((key) => {
      if (defaultCssVariables.light[key] !== input2.light[key]) {
        cleaned.light[key] = input2.light[key];
      }
    });
    keys(input2.dark).forEach((key) => {
      if (defaultCssVariables.dark[key] !== input2.dark[key]) {
        cleaned.dark[key] = input2.dark[key];
      }
    });
    return cleaned;
  }
...
`;
  ...
  function shortcutTokens$1(accelerator) {
    const trimmed = (accelerator == null ? void 0 : accelerator.trim()) ?? "";
    if (!trimmed) {
      return [];
    }
    return trimmed.split("+").map((part, index) => {
      const label2 = part.trim();
      return {
        id: `${label2}-${index}`,
        label: label2,
        symbol: TOKEN_SYMBOLS[label2]
      };
    });
  }
  ...
  function detectPathAutocompleteContext(input2, caret = input2.length) {
    var _a;
    const boundedCaret = Math.max(0, Math.min(caret, input2.length));
    const beforeCaret = input2.slice(0, boundedCaret);
  ...
  function buildPathAutocompleteState(input2, caret, aliases, folderPaths, homePath) {
    const context = detectPathAutocompleteContext(input2, caret);
    if (!context) {
      return {
        context: null,
        candidates: [],
  ...
  function inferHomePath$1(scopes) {
  ...
  function resolveIntentScopePath(scopeToken, scopePath, scopes) {
    const homePath = inferHomePath$1(scopes);
    if (scopePath) {
  ...
  new Map(launcherThemes.map((theme2) => [theme2.id, theme2]));
  ...
  const launcherRuntime = {
    ...
    getSettings() {
      var _a, _b;
      return ((_b = (_a = window.launcher) == null ? void 0 : _a.getSettings) == null ? void 0 : _b.call(_a).then((settings) => {
    ...
    getPathAutocomplete(input2, caret) {
      var _a;
      if ((_a = window.launcher) == null ? void 0 : _a.getPathAutocomplete) {
        return window.launcher.getPathAutocomplete(input2, caret);
      }
    ...
    saveSettings(settings) {
      var _a, _b;
      settingsCache = settings;
      return ((_b = (_a = window.launcher) == null ? void 0 : _a.saveSettings) == null ? void 0 : _b.call(_a, settings).then((nextSettings) => {
  ...
  const page = "_page_6iqhg_3";
  const shell = "_shell_6iqhg_15";
  const titlebar = "_titlebar_6iqhg_26";
  const header = "_header_6iqhg_32";
  const headerCopy = "_headerCopy_6iqhg_43";
  const title = "_title_6iqhg_26";
  const actions = "_actions_6iqhg_62";
  const body = "_body_6iqhg_70";
  const sidebarNav = "_sidebarNav_6iqhg_83";
  const content = "_content_6iqhg_93";
  const tab = "_tab_6iqhg_113";
  const tabActive = "_tabActive_6iqhg_139";
  const button = "_button_6iqhg_146";
  const secondaryButton = "_secondaryButton_6iqhg_147";
  const scopeActionButton = "_scopeActionButton_6iqhg_180";
  const scopePresetButton = "_scopePresetButton_6iqhg_181";
  const scopeComposerAdd = "_scopeComposerAdd_6iqhg_182";
  const scopeComposerCancel = "_scopeComposerCancel_6iqhg_183";
  const iconButton = "_iconButton_6iqhg_184";
  const grid = "_grid_6iqhg_226";
  const gridWithSidebar = "_gridWithSidebar_6iqhg_232";
  const gridSingle = "_gridSingle_6iqhg_236";
  const leftColumn = "_leftColumn_6iqhg_240";
  const rightColumn = "_rightColumn_6iqhg_241";
  const card = "_card_6iqhg_247";
  const cardTitle = "_cardTitle_6iqhg_255";
  const sectionHeader = "_sectionHeader_6iqhg_270";
  const fieldGrid = "_fieldGrid_6iqhg_277";
  const field = "_field_6iqhg_277";
  const fieldFull = "_fieldFull_6iqhg_285";
  const shortcutField = "_shortcutField_6iqhg_291";
  const shortcutButton = "_shortcutButton_6iqhg_297";
  const shortcutButtonCapturing = "_shortcutButtonCapturing_6iqhg_314";
  const shortcutTokens = "_shortcutTokens_6iqhg_319";
  const shortcutToken = "_shortcutToken_6iqhg_319";
  const shortcutTokenSymbol = "_shortcutTokenSymbol_6iqhg_337";
  const shortcutTokenLabel = "_shortcutTokenLabel_6iqhg_343";
  const shortcutPlaceholder = "_shortcutPlaceholder_6iqhg_350";
  const shortcutHint = "_shortcutHint_6iqhg_351";
  const label = "_label_6iqhg_368";
  const input = "_input_6iqhg_376";
  const select = "_select_6iqhg_377";
  const textarea = "_textarea_6iqhg_378";
  const toggleRow = "_toggleRow_6iqhg_407";
  const toggleCompact = "_toggleCompact_6iqhg_418";
  const toggleLabel = "_toggleLabel_6iqhg_433";
  const scopeToggleCompact = "_scopeToggleCompact_6iqhg_474";
  const list = "_list_6iqhg_530";
  const scopeMetrics = "_scopeMetrics_6iqhg_569";
  const scopeMetric = "_scopeMetric_6iqhg_569";
  const scopeMetricLabel = "_scopeMetricLabel_6iqhg_583";
  const scopeMetricValue = "_scopeMetricValue_6iqhg_591";
  const scopeToolbar = "_scopeToolbar_6iqhg_598";
  const scopePresetRow = "_scopePresetRow_6iqhg_614";
  const scopePresetButtonWarm = "_scopePresetButtonWarm_6iqhg_645";
  const scopePresetButtonDanger = "_scopePresetButtonDanger_6iqhg_649";
  const scopePresetButtonLabel = "_scopePresetButtonLabel_6iqhg_653";
  const scopeComposer = "_scopeComposer_6iqhg_182";
  const scopeComposerHeader = "_scopeComposerHeader_6iqhg_694";
  const scopeComposerTitle = "_scopeComposerTitle_6iqhg_701";
  const scopeComposerRow = "_scopeComposerRow_6iqhg_712";
  const scopeFeedback = "_scopeFeedback_6iqhg_719";
  const scopeList = "_scopeList_6iqhg_729";
  const scopeRow = "_scopeRow_6iqhg_736";
  const row = "_row_6iqhg_747";
  const rowHeader = "_rowHeader_6iqhg_757";
  const rowTitle = "_rowTitle_6iqhg_764";
  const statusRow = "_statusRow_6iqhg_788";
  const statusPill = "_statusPill_6iqhg_792";
  const statusPillReady = "_statusPillReady_6iqhg_804";
  const statusPillPending = "_statusPillPending_6iqhg_809";
  const statusPillError = "_statusPillError_6iqhg_814";
  const errorList = "_errorList_6iqhg_819";
  const hintList = "_hintList_6iqhg_842";
  const scopeInsightRow = "_scopeInsightRow_6iqhg_850";
  const scopeCostPill = "_scopeCostPill_6iqhg_858";
  const scopeCostLow = "_scopeCostLow_6iqhg_869";
  const scopeCostMedium = "_scopeCostMedium_6iqhg_874";
  const scopeCostHigh = "_scopeCostHigh_6iqhg_879";
  const scopeInsightMeta = "_scopeInsightMeta_6iqhg_884";
  const scopeInsightText = "_scopeInsightText_6iqhg_889";
  const performanceGrid = "_performanceGrid_6iqhg_899";
  const performanceMetric = "_performanceMetric_6iqhg_906";
  const performanceLabel = "_performanceLabel_6iqhg_916";
  const performanceValue = "_performanceValue_6iqhg_921";
  const scopeHeaderRow = "_scopeHeaderRow_6iqhg_963";
  const scopeRowGrid = "_scopeRowGrid_6iqhg_984";
  const scopeTogglePair = "_scopeTogglePair_6iqhg_988";
  const reference = "_reference_6iqhg_1013";
  const classes = {
    page,
    shell,
    titlebar,
    ...
    scopeToolbar,
    scopePresetRow,
    scopePresetButtonWarm,
    scopePresetButtonDanger,
    scopePresetButtonLabel,
    scopeComposer,
    scopeComposerHeader,
    scopeComposerTitle,
    scopeComposerRow,
  ...
  function validate(settings) {
    const aliasTriggers = /* @__PURE__ */ new Set();
    const snippetTriggers = /* @__PURE__ */ new Set();
  ...
  function SettingsViewV3() {
    ...
    const [saveState, setSaveState] = reactExports.useState("Loading settings...");
    const [isSaving, setIsSaving] = reactExports.useState(false);
    const [isCapturingShortcut, setIsCapturingShortcut] = reactExports.useState(false);
    const [activeTab, setActiveTab] = reactExports.useState("overview");
    const [isAddingScope, setIsAddingScope] = reactExports.useState(false);
    const [newScopePath, setNewScopePath] = reactExports.useState("");
    const [scopeFeedback2, setScopeFeedback] = reactExports.useState(null);
    const scopeListRef = reactExports.useRef(null);
    ...
    const revealNewestScope = () => {
      window.requestAnimationFrame(() => {
        ...
        const lastScope = container == null ? void 0 : container.lastElementChild;
        lastScope == null ? void 0 : lastScope.scrollIntoView({ block: "nearest", behavior: "smooth" });
        const pathField = lastScope == null ? void 0 : lastScope.querySelector('input[data-scope-path="true"]');
        pathField == null ? void 0 : pathField.focus();
        pathField == null ? void 0 : pathField.select();
      });
    };
    const showScopeFeedback = (message) => {
      setScopeFeedback(message);
      window.clearTimeout(showScopeFeedback.timer);
      showScopeFeedback.timer = window.setTimeout(() => setScopeFeedback(null), 2400);
    };
    const save = async () => {
    ...
    const displayTokens = shortcutTokens$1(displayedShortcut);
    ...
    const addCustomScope = () => {
      ...
      if (!addScopePath(newScopePath)) {
        if (!newScopePath.trim()) {
          (_a = newScopeInputRef.current) == null ? void 0 : _a.focus();
        }
        return;
      }
      setNewScopePath("");
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: classes.page, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.shell, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: classes.header, "data-settings-role": "header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.headerCopy, "data-settings-role": "header-copy", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.title, children: "Settings" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.actions, "data-settings-role": "header-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: classes.secondaryButton, "data-settings-role": "secondary-button", type: "button", onClick: () => setSettings(cloneSettings(launcherRuntime.getSettingsSnapshot())), children: "Revert" }),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.leftColumn, children: [
                activeTab === "overview" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: classes.card, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.cardTitle, children: "Search" }),
                  ...
                  ].map(([key, label2, help]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: classes.toggleCompact, title: help, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.toggleLabel, children: label2 }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "checkbox",
                        "aria-label": `${label2}. ${help}`,
                ...
                activeTab === "overview" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: classes.card, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.cardTitle, children: "Launcher" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.fieldGrid, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: classes.field, children: [
                ...
                activeTab === "scopes" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: classes.card, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.sectionHeader, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeHeaderRow, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.cardTitle, children: "Scopes" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeMetrics, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeMetric, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.scopeMetricLabel, children: "On" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.scopeMetricValue, children: enabledScopes })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeMetric, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.scopeMetricLabel, children: "FS watch" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.scopeToolbar, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.scopePresetRow, children: scopePresets.map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.scopePresetButtonLabel, children: preset.id === "library" ? "~/Library" : preset.id === "home" ? "Home" : "Entire disk" })
                    },
                    preset.id
                  )) }) }),
                  isAddingScope ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeComposer, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeComposerHeader, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.scopeComposerTitle, children: "Custom path" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.toggleRow, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "label",
                    {
                      className: classes.toggleCompact,
                      title: "Refresh search results sooner when files change under enabled scopes.",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.toggleLabel, children: "Watch filesystem for changes" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            type: "checkbox",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.scopeList, ref: scopeListRef, children: settings.scopes.map((scope, index) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeRow, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.rowHeader, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.rowTitle, title: scope.path || "Empty path", children: scope.path.trim() ? scope.path : `Scope ${index + 1}` }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            className: classes.iconButton,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${classes.fieldGrid} ${classes.scopeRowGrid}`, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: classes.fieldFull, children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeTogglePair, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "label",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.toggleLabel, children: "On" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "input",
                                  {
                                    type: "checkbox",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "label",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes.toggleLabel, children: "Fast" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "input",
                                  {
                                    type: "checkbox",
                      ...
                      insight ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.scopeInsightRow, title: insight.recommendation, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.rightColumn, children: [
                ...
                activeTab === "scopes" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: classes.card, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.cardTitle, children: "Latency (local samples)" }),
                ...
                activeTab === "scopes" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: classes.reference, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { children: "Scope reference" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: classes.hintList, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Fast path: low-latency tier before deep search finishes." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Use fast paths for apps, Desktop-like folders, and daily workspaces." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "~/Library is the usual expansion for app support and preferences." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Disabled scopes stay saved but do not feed search." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Avoid fast path on huge trees unless you need that speed daily." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Broader scopes add hydrate time and noise." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "FS watch refreshes stale results faster; broad scope sets stay busier." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Entire disk (/) is the widest, slowest option." })
                  ] })
                ] }) : null
              ] })
            ]
  ...
  ReactDOM.createRoot(document.getElementById("root")).render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(MantineProvider, { theme, defaultColorScheme: "dark", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsViewV3, {}) }) })
  );
})();
//# sourceMappingURL=settings-current-view3.js.map
