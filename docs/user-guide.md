...
- File previews now fall back to content-based text detection, so extensionless documents and files with unusual extensions still show readable plain-text bodies when their contents are actually text.
