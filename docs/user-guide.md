...
- The settings window logs explicit load, failure, renderer-console, and crash diagnostics under `settings-window`, and it shows a visible error state if settings data cannot load.
